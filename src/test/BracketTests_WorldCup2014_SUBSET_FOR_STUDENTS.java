...
import tournament.BracketImpl_Martinez;
...
public class BracketTests_WorldCup2014_SUBSET_FOR_STUDENTS
{
	...
	@Rule public Timeout globalTimeout= new Timeout(900000);
	...
	public void setUp()
	{
		...
		worldCup2014KnockoutResults_ALT = new BracketImpl_Martinez<FIFASoccerTeam>(worldCup2014KnockoutRoundMatchups_ALT);
		...
		worldCup2014KnockoutResults_NETHERLANDS_WINS_INSTEAD = new BracketImpl_Martinez<FIFASoccerTeam>(worldCup2014KnockoutRoundMatchups_ALT);
		...
		worldCup_DEGENERATE = new BracketImpl_Martinez<FIFASoccerTeam>(matchups_DEGENERATE);
	}
	...
	public void testGetGroupings1()
	{
		...
		// ((BracketImpl_Martinez<FIFASoccerTeam>) worldCup2014KnockoutResults).printBracket();
		worldCup2014KnockoutResults.toString();
	...
	{
		TEST_GOAL_MESSAGE = "Test getGroupings Level 4";
		Set<Set<FIFASoccerTeam>> groupingsLevel4 = worldCup2014KnockoutResults.getGroupings(4);
		System.out.println("groupingsLevel3 = " + groupingsLevel4);
		// ((BracketImpl_Martinez<FIFASoccerTeam>) worldCup2014KnockoutResults).printBracket();
